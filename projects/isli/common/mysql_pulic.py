...
if __name__ == "__main__":
    ...
    # sum = 0
    # A = MysqlUtil()
    # list1 = open(r"E:\sql.txt",'r')
    # a = list1.readlines()
    # list1.close()
    # for i in a:
    #     c = str(int(i)).zfill(10)
    #     sql = ("SELECT isli_prefix_code,file_format,book_name FROM t_book where isli_prefix_code = %s and status = 0"%c)
    #     A.mysql_execute(sql)
    #     z = A.mysql_getrows(sql)
    #     if z:
    #         L.append(z)
    #         sum +=1
    #     else:
